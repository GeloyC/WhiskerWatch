...
const AdopteeForm = () => {
    ...
    const isFormStarted = Boolean(
        ...
        pickup ||
        moreInfo.trim() ||
        imageSrc !== '/src/assets/icons/id-card.png' 
    );
    ...
    return (
        <div className='flex flex-col min-h-screen'>
            ...
            <div className='flex flex-col items-center py-0 xl:py-10 lg:py-10 w-auto h-full'>
                <div className='flex flex-col w-auto h-auto xl:w-[1200px] lg:w-[1000px] h-full md:gap-5 lg:gap-2 xl:gap-2'>
                    <div className='relative flex flex-col h-full w-full xl:grid xl:grid-cols-[20%_80%] lg:flex lg:flex-col rounded-[25px] gap-2'>
                        <div className='hidden xl:flex xl:flex-col lg:flex lg:flex-row md:flex md:hidden w-full xl:gap-10 lg:gap-2 md:gap-2 sm:gap-2'>
                            ...
                            <form ref={printRef} className='hidden xl:flex xl:flex-col lg:flex lg:flex-col items-start w-full p-5 gap-5 bg-[#FFF] rounded-[15px]' > 
                                ...
                                <div className='flex flex-col gap-2'>
                                    ...
                                    <div className='flex flex-row items-center gap-2'>
                                        ...
                                        <div className='flex flex-col w-auto'>
                                            <label htmlFor="idUpload" className='bg-[#DC8801] p-2 rounded-[10px] text-[#FFF] hover:bg-[#B67101] active:scale-97'>
                                                Attach ID Photo
                                                <input type="file" accept="image/*" id='idUpload' hidden onChange={handleImageChange} required/>
                                            </label>

                                            <span className='italic text-[#828282] text-[14px]'>
                                ...
                                <div className='flex flex-col gap-3'>
                                    <div className='flex flex-col'>
                                        ...
                                        <span className='italic text-[14px] text-[#7d7d7d]'>(Eg. "Yes, I have two dogs.")</span>
                                    </div>
                                ...
                                <div className='flex flex-col gap-2'>
                                    <div className='flex flex-col '> 
                                        <span htmlFor="">7. Do you have a regular income?</span>
                                        <span className='italic text-[14px] leading-tight text-[#898989]'>(Raising indoor cats involves costs for essentials like food, litter, vitamins, vaccinations, and other necessities. SPR cats are trained to be indoor-only pets (owners are advised to keep them indoors for safety) and are litter box-trained before being made available for adoption.)</span>
                                    </div>
                                ...
                                <div className='flex flex-col gap-2'>
                                    <span htmlFor="">9. Please share any additional information in order for us to know you better, we'd love to know more about you.</span>
                    ...
                    {isFormStarted && (
                        <button
                            ...
                            disabled={loading}
                            className={`self-end cursor-pointer w-full xl:w-fit lg:w-fit md:w-fit sm:w-full text-center font-bold p-2 pl-5 pr-5 rounded-[10px] 
